...
function sahara_river(argument) {
  return "Nile River";
}
...
Stapler.prototype.staplePapers = function(paperAmount){
...
Scientist.prototype.addDiscipline = function(argument){
  this.disciplines.push(argument);
  return this.disciplines;
};

Scientist.prototype.checkDiscipline = function(argument){
  if(this.disciplines.indexOf(argument) > -1){
    return true;
  } else {
    return false;
  }
...
var polygon = new Shape("Over 9000").getType();
 ...
 *
 */
var farTooTallAStory = new House(9000).isATallStory(1);
var shortStory = new House(1).isATallStory(9000);
...
var goodForYou = new Meal(["great food", "vegetables", "vegan stuff", "alcohol"]).containsJunkFood();
